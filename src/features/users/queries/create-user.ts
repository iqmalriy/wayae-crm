...
import type { CreateUserOutput } from "../types/response-types";
...
): Promise<{ message: string; data: CreateUserOutput }> {
...
export type CreateUserMutationOptions = UseMutationOptions<
  { message: string; data: CreateUserOutput },
  AppError,
  CreateUserInput
>;
